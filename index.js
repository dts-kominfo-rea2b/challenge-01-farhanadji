...
const monicaFavoriteColor = Array.from(
    new Set([
        "Yellow", "Pink", "White", "Purple"
    ])
);

const monicaFavoriteRestaurant = Array.from(
    new Set([
        "Bento", "Sushi", "Pancake", "Eggy", "Tempura", "Bento", "Eggy", "Padang", "Tteok", "Sushi", "Sushi"
    ])
);

const wendyFavoriteColor =  Array.from(
    new Set([
        "Blue", "Black", "Grey"
    ])
);

const wendyFavoriteRestaurant = Array.from(
    new Set([
